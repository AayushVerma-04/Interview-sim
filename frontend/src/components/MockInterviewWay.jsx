...
const MockInterviewWay = () => {
  ...
  const handleFileUpload = async (event) => {
    ...
    try {
      ...
      const response = await axios.post("/api/v1/ai/aiUploadResume", formData, {
      ...
      if (response.data.success) {
        ...
        console.log(
          "File uploaded successfully, sessionId:",
  ...
  return (
    <Box
      sx={{
        background:
          "linear-gradient(-45deg, #0a0f1a, #1a1a2e, #16213e, #0d1b2a)",
        ...
        "&::before": {
          ...
          height: "120px",
          background:
            "linear-gradient(to bottom, rgba(10, 15, 26, 0.98), rgba(10, 15, 26, 0.85), transparent)",
          zIndex: 1,
          pointerEvents: "none",
        },
      }}
    >
      ...
      <Box
        sx={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(0, 191, 165, 0.15) 0%, rgba(0, 172, 193, 0) 70%)",
          zIndex: 0,
      ...
      <Box
        sx={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(0, 172, 193, 0.1) 0%, rgba(0, 172, 193, 0) 70%)",
          zIndex: 0,
                ...
                >
                  <StyledButton
                    ...
                    sx={{
                      ...
                      "&:hover": {
                        background:
                          "linear-gradient(90deg, #00a58e 0%, #0097a7 100%)",
