  ...
  useEffect(() => {
    if (notifications.length > 0) {
      ...
      localStorage.setItem(
        "notifications",
        JSON.stringify(notificationsForStorage)
      );
    }
  }, [notifications]);
      ...
      const mockNotifications = [
        {
          ...
          message:
            "Your mock interview for Senior Frontend Engineer is scheduled for tomorrow at 2:00 PM",
          type: "interview",
          read: false,
        ...
        },
        {
          ...
          message:
            "Check out our new practice questions for system design interviews",
          type: "announcement",
          read: true,
            ...
            {isAuthenticated ? (
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Box sx={{ display: { xs: "none", md: "block" } }}>
                        ...
                        >
                          {user?.email ||
                            (isLoading ? "Verifying..." : "Premium Member")}
                        </Typography>
                      </Box>
                    </Box>
                  </motion.div>
                ...
                >
                  ...
                  <Divider
                    sx={{ my: 0.5, bgcolor: "rgba(255,255,255,0.05)" }}
                  />
            ...
            >
              ...
              {isAuthenticated ? (
                <>
                  ...
                  >
                    <ListItemIcon
                      sx={{ color: "inherit", minWidth: 40, margin: 0 }}
                    >
                      <PersonIcon fontSize="small" />
                    </ListItemIcon>
                    <span>Profile</span>
